...
| 日期 | 文件 | 内容摘要 |
|:---|:---|:---|
| 2026-07-06 | [memory/2026-07-06.md](memory/2026-07-06.md) | 前端重写 v2.0、概念边截断修复、孤立节点隐藏、LA-026 布局修复 |
| 2026-07-05 | [memory/2026-07-05.md](memory/2026-07-05.md) | 设计文档、导入流程修复、布局算法调整 |
| 2026-07-04 | [memory/2026-07-04.md](memory/2026-07-04.md) | 后端崩溃排查、LA-021 COSE 布局修复、graph_store.py 编码修复 |
| 2026-07-03 | [memory/2026-07-03.md](memory/2026-07-03.md) | LA-020/021/024 新增 |
| 2026-07-02 | [docs/progress_2026-07-02.md](docs/progress_2026-07-02.md) | 树形布局渲染问题 |
| 2026-07-01 | [memory/2026-07-01.md](memory/2026-07-01.md) | 范式选择 UI + 多范式提示词优化 |
| 持续更新 | [docs/leftover-problem.md](docs/leftover-problem.md) | **遗留问题清单（最新状态）** |
| 设计文档 | [docs/DESIGN.md](docs/DESIGN.md) | 项目设计文档 v1.0 |

...
替换 get_subgraph, get_concepts_for_chunk, get_semantic_edges
"""
import re
...
old_subgraph = '''    def get_subgraph(self, chunk_id: str, depth: int = 2) -> Dict[str, Any]:
...
if old_subgraph in content:
    ...
    print("Fixed get_subgraph() - OK")
else:
    print("WARNING: get_subgraph old text not found")

# ========== 2. 修复 get_concepts_for_chunk ==========

old_concepts_chunk = '''    def get_concepts_for_chunk(self, chunk_id: str) -> List[Dict[str, Any]]:
...
new_concepts_chunk = '''    def get_concepts_for_chunk(self, chunk_id: str) -> List[Dict[str, Any]]:
...
if old_concepts_chunk in content:
    content = content.replace(old_concepts_chunk, new_concepts_chunk)
    print("Fixed get_concepts_for_chunk() - OK")
else:
    print("WARNING: get_concepts_for_chunk old text not found")

# ========== 3. 修复 get_semantic_edges ==========

old_semantic = '''    def get_semantic_edges(self, limit: int = 200) -> List[Dict[str, Any]]:
...
if old_semantic in content:
    ...
    print("Fixed get_semantic_edges() - OK")
else:
    print("WARNING: get_semantic_edges old text not found")
